...
users_dict = {}
with open('users.csv', 'r', encoding='Windows-1251') as file_1:
    with open('hobby.csv', 'r', encoding='Windows-1251') as file_2:
        for names, hobbyes in zip_longest(file_1, file_2, fillvalue='None'):
            users_dict.setdefault(names.rstrip(), hobbyes.rstrip())
with open('users_hobby.txt', 'w', encoding='Windows-1251') as file_3:
